...
See [`guide/`](guide/) for quests, dailies, graves, and player commands.

## Server and plugin guides

See [`mod-guides/`](mod-guides/) for operator notes about the Paper plugins used by snaxcraft.
