...
snaxcraft adds five smithing equipment families. These are extra upgrade paths; vanilla diamond-to-netherite smithing still works as normal.

| Set | Upgrades | Material you add | What it is good at |
|-----|----------|------------------|--------------------|
| **Hepatizon** | Copper gear | Phantom Membrane | Attack speed and movement |
| **Shakudo** | Copper gear | Shulker Shell | Passive healing while worn |
| **Steel** | Iron gear | Resin Brick | Explosions and blocking |
| **Electrum** | Diamond gear | Heart of the Sea | Harming nearby monsters, tool luck |
| **Adamant** | Diamond gear | Netherite Ingot | Absorption hearts, highest damage |

## How to make them

Alloy gear is made at a **smithing table**, not a crafting table. You cannot get these from a normal crafting grid, a furnace, or an anvil.

A smithing table has three input slots in a row and one output slot. Left to right, the inputs are:

1. **Template** (left slot) - for most alloy pieces this is just an ingot or gem, such as a Copper Ingot or a Diamond. A few pieces want a real Netherite Upgrade Smithing Template instead.
2. **Base** (middle slot) - the finished piece of gear you are upgrading, such as a Copper Axe or Diamond Chestplate. It must already be the tool or armor piece, not raw material.
3. **Addition** (right slot) - the material that decides which alloy you get, such as Phantom Membrane for Hepatizon or Netherite Ingot for Adamant.
...
Each piece lists plain **Stats** (damage, mining speed, armor, and so on). Most also carry effects, listed under **Comes enchanted with**.

Custom effects added by snaxcraft:

- **Divinity** (Adamant) - grants Absorption while equipped. It counts every Adamant piece you wear or hold, so more Adamant means stronger Absorption: one piece gives Absorption I, two gives II, three gives III, and a full set jumps to Absorption V. It refreshes on its own as long as the gear stays equipped.
- **Warding** (Electrum) - an aura that damages and slows hostile mobs within roughly 6 to 8 blocks of you, without you attacking. Wearing more Electrum makes it tick faster and hit harder, and a full set also grants Absorption. Mobs wearing copper armor resist it.
- **Shakudo Regeneration** (Shakudo) - periodically gives you Regeneration while worn. Each extra Shakudo piece shortens the gap between pulses, and a large amount upgrades it to Regeneration II.
- **Riposte** (Hepatizon) - when you hit a mob, you lunge backward out of range. It does not work while riding, gliding with an elytra, or in water, and it costs a point of durability per use.
- **Sanguine** - life steal: attacking heals you for part of the damage dealt.
- **Magic Protection** / **Greater Magic Protection** - extra armor against damage that normal armor ignores.
- **Cleanse** - clears harmful status effects off you while the armor is worn.

Vanilla enchantments such as Unbreaking, Protection, Blast Protection, Fortune, Silk Touch, Looting, Smite, Sweeping Edge, and Lunge behave exactly as they do in normal Minecraft.

Source: https://minecraft.wiki/w/Absorption<br>
Source: https://minecraft.wiki/w/Regeneration

### Set bonuses

Lines shown as **Set Bonus** only reach full strength when you wear the whole matching set. Partial sets still count - the effects above scale with the number of pieces equipped, so two Adamant pieces are better than one. Lines shown as **When Blocking** apply only while you are actively blocking, and **Per Equipment Bonus** lines apply once for each matching piece you have on.

## Recipe catalog

## Hepatizon

Hepatizon upgrades copper-tier gear using Phantom Membrane. Its pieces trade raw damage for speed and movement, and its sword line carries Riposte.
...
**Smithing table:** Copper Ingot in the left slot, Copper Boots in the middle, Phantom Membrane on the right.

**Stats:** Armor 3, Movement +0.01.
...
**Smithing table:** Netherite Upgrade Smithing Template in the left slot, Copper Axe in the middle, Phantom Membrane on the right.

The middle slot really is a **Copper Axe**, not a dolabra. The recipe upgrades a normal axe into the alloy dolabra.

**Stats:** Mining Speed 10, Damage 7, Attack Speed 1, Movement +0.003.
...
**Smithing table:** Copper Ingot in the left slot, Copper Helmet in the middle, Phantom Membrane on the right.
...
**Stats:** Mining Speed 15, Damage 1, Attack Speed 4, Movement +0.005.
...
**Smithing table:** Netherite Upgrade Smithing Template in the left slot, Copper Hoe in the middle, Phantom Membrane on the right.

The middle slot really is a **Copper Hoe**, not a mattock. The recipe upgrades a normal hoe into the alloy mattock.

**Stats:** Mining Speed 10, Damage 3.5, Attack Speed 3, Movement +0.01.
...
**Stats:** Mining Speed 15, Damage 4.5, Attack Speed 1.2, Movement +0.005.
...
**Smithing table:** Copper Ingot in the left slot, Copper Spear in the middle, Phantom Membrane on the right.

**Stats:** Damage 3, Attack Speed 1.18, Movement +0.01.
...
**Smithing table:** Copper Ingot in the left slot, Copper Sword in the middle, Phantom Membrane on the right.

**Stats:** Damage 6, Attack Speed 1.9, Movement +0.01.

**Comes enchanted with:** Riposte.

**When Blocking: 75% Melee Blocking**

**When Blocking: 25% Projectile Blocking**

## Shakudo

Shakudo upgrades copper-tier gear using Shulker Shell. Its armor slowly heals you, and heals faster the more Shakudo you wear.
...
**Stats:** Mining Speed 9, Damage 9, Attack Speed 1.
...
**Smithing table:** Copper Ingot in the left slot, Copper Boots in the middle, Shulker Shell on the right.

**Stats:** Armor 3.

**Comes enchanted with:** Cleanse, Magic Protection, Shakudo Regeneration.
...
**Smithing table:** Netherite Upgrade Smithing Template in the left slot, Copper Axe in the middle, Shulker Shell on the right.

The middle slot really is a **Copper Axe**, not a dolabra. The recipe upgrades a normal axe into the alloy dolabra.

**Stats:** Mining Speed 7, Damage 7, Attack Speed 1.
...
**Comes enchanted with:** Cleanse, Greater Magic Protection, Shakudo Regeneration.
...
**Smithing table:** Copper Ingot in the left slot, Copper Helmet in the middle, Shulker Shell on the right.
...
**Stats:** Mining Speed 9, Damage 1, Attack Speed 4.
...
**Smithing table:** Copper Ingot in the left slot, Copper Leggings in the middle, Shulker Shell on the right.
...
**Stats:** Mining Speed 8, Damage 4, Attack Speed 4.
...
**Stats:** Mining Speed 9, Damage 4, Attack Speed 1.2.
...
**Smithing table:** Copper Ingot in the left slot, Copper Shovel in the middle, Shulker Shell on the right.

**Stats:** Mining Speed 9, Damage 4.5, Attack Speed 1.
...
**Stats:** Damage 3, Attack Speed 1.18.
...
**Smithing table:** Copper Ingot in the left slot, Copper Sword in the middle, Shulker Shell on the right.

**Stats:** Damage 6, Attack Speed 1.6.

**Comes enchanted with:** Sanguine, Sweeping Edge.

## Steel

Steel upgrades iron-tier gear using Resin Brick. It leans on Blast Protection and on blocking damage with weapons that can block.
...
**Smithing table:** Iron Ingot in the left slot, Iron Boots in the middle, Resin Brick on the right.

**Stats:** Knockback Resist +1, Armor 2, Toughness 1.

**Comes enchanted with:** Blast Protection II.
...
**Stats:** Knockback Resist +2, Armor 7, Toughness 1.
...
**Smithing table:** Netherite Upgrade Smithing Template in the left slot, Iron Axe in the middle, Resin Brick on the right.

The middle slot really is a **Iron Axe**, not a dolabra. The recipe upgrades a normal axe into the alloy dolabra.

**Stats:** Mining Speed 7, Damage 6, Attack Speed 0.9.
...
**Smithing table:** Iron Ingot in the left slot, Iron Leggings in the middle, Resin Brick on the right.

**Stats:** Knockback Resist +1, Armor 5, Toughness 1.

**Comes enchanted with:** Blast Protection III.
...
The middle slot really is a **Iron Hoe**, not a mattock. The recipe upgrades a normal hoe into the alloy mattock.

**Stats:** Mining Speed 7, Damage 1, Attack Speed 3.
...
**Smithing table:** Iron Ingot in the left slot, Shears in the middle, Resin Brick on the right.

No extra stats or effects beyond the vanilla item it is based on.
...
**Stats:** Mining Speed 8, Damage 4.5, Attack Speed 1.
...
**Smithing table:** Iron Ingot in the left slot, Iron Sword in the middle, Resin Brick on the right.

**Stats:** Knockback 1, Damage 6, Attack Speed 0.9.

**When Blocking: 50% Melee Blocking**

**When Blocking: 25% Projectile Blocking**

## Electrum

Electrum upgrades diamond-tier gear using Heart of the Sea. It carries Warding, which hurts nearby monsters on its own, plus tool luck enchantments.
...
**Stats:** Mining Speed 12, Damage 9, Attack Speed 1.2.
...
**Smithing table:** Diamond in the left slot, Diamond Boots in the middle, Heart of the Sea on the right.

**Stats:** Armor 3, Toughness 3.

**Comes enchanted with:** Warding.

**Set Bonus: Warding Max**

**Set Bonus: 4 hearts of Absorption (00:30)**
...
The middle slot really is a **Diamond Axe**, not a dolabra. The recipe upgrades a normal axe into the alloy dolabra.

**Stats:** Mining Speed 10, Damage 6, Attack Speed 1.2.
...
**Smithing table:** Diamond in the left slot, Diamond Helmet in the middle, Heart of the Sea on the right.
...
**Stats:** Mining Speed 12, Damage 1, Attack Speed 4.
...
**Smithing table:** Diamond in the left slot, Diamond Leggings in the middle, Heart of the Sea on the right.

**Stats:** Armor 6, Toughness 3.
...
The middle slot really is a **Diamond Hoe**, not a mattock. The recipe upgrades a normal hoe into the alloy mattock.

**Stats:** Mining Speed 10, Damage 3, Attack Speed 3.

**Comes enchanted with:** Fortune II, Warding.
...
**Stats:** Mining Speed 12, Damage 5, Attack Speed 1.2.
...
**Smithing table:** Diamond in the left slot, Diamond Shovel in the middle, Heart of the Sea on the right.

**Stats:** Mining Speed 12, Damage 6, Attack Speed 1.
...
**Stats:** Damage 4, Attack Speed 1.18.
...
**Smithing table:** Diamond in the left slot, Diamond Sword in the middle, Heart of the Sea on the right.

**Stats:** Damage 7, Attack Speed 1.9.

**Comes enchanted with:** Looting II, Smite II, Warding.

## Adamant

Adamant upgrades diamond-tier gear using Netherite Ingot. Every piece carries Divinity, which grants Absorption that scales with how much Adamant you have equipped.
...
**Stats:** Mining Speed 15, Damage 10, Attack Speed 1.
...
**Smithing table:** Diamond in the left slot, Diamond Boots in the middle, Netherite Ingot on the right.

**Stats:** Armor 3, Toughness 3, Knockback Resist 1.

**Comes enchanted with:** Divinity, Protection, Unbreaking II.
...
**Stats:** Armor 8, Toughness 3, Knockback Resist 1.
...
**Smithing table:** Netherite Upgrade Smithing Template in the left slot, Diamond Sword in the middle, Netherite Ingot on the right.

**Stats:** Damage 9, Attack Speed 0.5.

**Comes enchanted with:** Divinity, Unbreaking II.

**Set Bonus: Absorption (00:30) -> Absorption (00:20)**

**When Blocking: 80% Melee Blocking**

**When Blocking: 70% Projectile Blocking**
...
**Stats:** Mining Speed 13, Damage 10, Attack Speed 1.
...
**Stats:** Mining Speed 15, Damage 1, Attack Speed 4.
...
**Smithing table:** Diamond in the left slot, Diamond Leggings in the middle, Netherite Ingot on the right.

**Stats:** Armor 6, Toughness 3, Knockback Resist 1.
...
**Smithing table:** Netherite Upgrade Smithing Template in the left slot, Diamond Hoe in the middle, Netherite Ingot on the right.

The middle slot really is a **Diamond Hoe**, not a mattock. The recipe upgrades a normal hoe into the alloy mattock.

**Stats:** Mining Speed 13, Damage 1, Attack Speed 4.
...
**Stats:** Mining Speed 15, Damage 6, Attack Speed 1.2.
...
**Smithing table:** Diamond in the left slot, Diamond Shovel in the middle, Netherite Ingot on the right.

**Stats:** Mining Speed 15, Damage 6.5, Attack Speed 1.
...
**Stats:** Damage 4, Attack Speed 0.95.
...
**Smithing table:** Diamond in the left slot, Diamond Sword in the middle, Netherite Ingot on the right.

**Stats:** Damage 8, Attack Speed 1.6.
